...
So, whether you're a seasoned cricketer or a complete beginner, come and join us for our Bombay style box cricket event and experience the thrill of       this unique and exciting variation of the sport, organised by the Chemical Engineering department of Nirma University under “AARAMBH”.`,
...

	{
		...
		venue: 'A-Audi',
		time: `3 Hours`,
		price: `Winning Price = Rs 1500/-
                             Runner’s up = Rs 1000/-`,
		Fees: `ChESA member : 150 INR
...
The competition consists of four offline rounds basis on the four cards, and it is mandatory to survive in each round to avoid elimination. Only the participant who manages to survive in all four rounds will be declared the winner and will be considered the "last man standing" and will be awarded with the prize.`,
		...
		image: '/P3.png',
		venue: 'A-Block (Exact Location share at the time of the event)',
		time: `3 Hours`,
...
The quiz will be conducted in 3 rounds. The quiz will contain both tech and non-tech questions. All the 3 rounds will be mcq based and the link for the quiz will be sent on the whatsapp group after registration is completed.`,
		...
		price: `Winning Price = Rs 500/- & E Certificates to all Participants`,
...
+91 9510651155`,
		image: '/P7.jpg',
		venue: 'A108, A207',
		time: `Refer the Rule Book
`,
		price: `Winning Price = Cash Prize & Hampers to Winners & Certificates to all Participants`,
		Fees: `ChESA member : 50 INR
...
`,
	...
	},
	{
		...
		slug: 'P9',
		name: 'PIXILLENCE',
		description: `This is a Photography and Video making competition organised by ChESA, Chemical Department Club. It is organised on 17th and 18th March. 
...
`,
		...
		image: '/P11.png',
		venue: 'Online',
		time: ` Qualifiers for the event will start on 15th March

- Dates for the semifinals and finals are 17th, 18th of March respectively.

- Co-operation from all the participants is sincerely expected.

- Timings will be negotiated for valid reasons.

- Teams who don't show up on time will be disqualified.

- They will be contacted prior to their matches.
.`,
