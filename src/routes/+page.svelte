<div class="max-w-5xl my-8 container px-4 mx-auto">
	<div class=" bg-no-repeat bg-center bg-contain h-[24rem]" style="background-image: url('/main.png');">
	...
	<p class="sm:text-center text-justify">
		...
		cultural events, it will cater to the talents of students across all fields. The organising team
